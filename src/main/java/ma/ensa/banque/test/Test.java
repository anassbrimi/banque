...
public class Test {
	...
	public static void main(String[] args) {
		...
		IBanqueService service = (IBanqueService) context.getBean("banqueService");
		...
		// dao.addClient(new Client("AIT AL BRIMI", "Anass", "0655258921",
		// "N 330, Avenue 20 Aout, Taroudant", "anassbrimi1992@gmail.com",
		// "123456789"));
		// dao.addEmploye(new Employe("KADIRI", "Khalid", "0600259715",
		// "Agadir", "khalid.kadiri@gmail.com", "123456789", "CC"));
		...
		// Client c = new Client("AIT AL BRIMI", "Anass", "0655258921",
		// "Agadir", "anassbrimi992@gmail.com");
		// dao.addClient(c);
