								...
								<div class="panel panel-primary">
									<div class="panel-heading">
										<div class="row">
											...
											<div class="col-xs-9 text-right">
												<div class="huge">${nombreOpsEff}</div>
												<div>
													<h4 style="margin-top: 24px; margin-bottom: 17px;">Transactions Done</h4>
												</div>
											</div>
										</div>
									</div>
				...
				<div class="row">
					<div class="col-lg-8 col-lg-offset-2">
						...
						<table class="table table-bordered table-hover">
							<caption>Latest Opened Account</caption>
							<thead>
								<tr>
									<th>DATE</th>
									<th>FIRST NAME</th>
