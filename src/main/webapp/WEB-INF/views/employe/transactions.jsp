...
<title>Espace Employe - Transactions</title>
</head>
<body>
		...
		<div id="page-content-wrapper">
			...
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2">
					...
					<table class="table table-hover">
						<caption>Transactions Done</caption>
						<thead>
							<tr>
								<th>TYPE</th>
								<th>DATE</th>
						...
						<tbody>
							<c:forEach items="${transactionsDone}" var="op">
								<tr>

									<td>${op}</td>
									<td>${op.dateOperation}</td>
									<td>${op.compte.client.prenomPersonne}</td>
									<td>${op.compte.client.nomPersonne}</td>
									<td>${op.compte.client.telePersonne}</td>
									<td>${op.montant}</td>
			...
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2">
					...
					<table class="table table-hover">
						<caption>Other Transactions</caption>
						<thead>
							<tr>
								<th>TYPE</th>
								<th>DATE</th>
						...
						<tbody>
							<c:forEach items="${allTransactions}" var="op">
								<tr>
									...
									<td>${op.compte.client.nomPersonne}</td>
									<td>${op.compte.client.telePersonne}</td>
									<td>${op.compte.employe.prenomPersonne}  ${op.compte.employe.nomPersonne}</td>
									<td>${op.montant}</td>
								</tr>
